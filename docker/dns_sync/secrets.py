...
class SecretsManager:
    ...
    def get_credential(self, server_name, field):
        ...
        Lookup order:
        1. Env var  DNS_SYNC_{SERVER_NAME}_{FIELD}  (Docker-friendly, no encryption needed)
        2. Encrypted .enc file in secrets dir       (legacy CLI setup)
        """
        ...
        if not self.cipher:
            return None  # No cipher loaded; env var path still works above
